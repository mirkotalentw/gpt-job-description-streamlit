...
system_instruction = """
You are a recruiter for a tech company. You are writing a job description for a new position.
...
You are a recruiter for a tech company. You are writing a requirement profile for a new position.
